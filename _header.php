...
if(isset($_SESSION['loggedin']) && $_SESSION['loggedin']==true){
  echo '<form class="form-inline my-2 my-lg-0" method="get" action="search.php"> 
    ...
    <button class="btn btn-success my-2 my-sm-0" action="search.php" type="submit">Search</button>
  ...
  echo '<form class="form-inline my-2 my-lg-0">
    ...
    <button class="btn btn-success my-2 my-sm-0" href="search.php" type="submit">Search</button>
    </form>
